    ...
    <section style={styles.overlay} role="dialog" aria-modal="true" aria-labelledby="passport-editor-title">
      <div style={styles.editor}>
        ...
        <div style={styles.actions}>
          <button type="button" style={styles.save} onClick={onSave} disabled={saving}>{saving ? 'SAVING…' : 'SAVE PROFILE'}</button>
...
const styles = {
  ...
  input: { width: '100%', boxSizing: 'border-box', minHeight: 46, padding: '11px 12px', borderRadius: 12, border: '1px solid rgba(255,255,255,.15)', color: '#fff', background: '#080c0b' }, message: { margin: '4px 0 0', color: '#cde7c9' }, actions: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 9, marginTop: 12 },
